  ...
  const poolTypes = [
    {
      ...
      title: "Weighted Pool",
      description:
        "Create a pool with custom weight distribution between tokens. Ideal for index funds or structured products.",
      icon: FaBalanceScale,
    },
    {
      id: "composableStable",
      ...
      description:
        "Optimized for tokens that maintain similar values. Perfect for stablecoins or synthetics.",
      icon: FaLayerGroup,
    },
  ];
