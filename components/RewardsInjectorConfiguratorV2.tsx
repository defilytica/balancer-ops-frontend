...
function RewardsInjectorConfiguratorV2({
    ...
    const calculateCurrentDistribution = (gauges: RewardsInjectorData[]) => {
        const distribution = gauges.reduce((acc, gauge) => {
    ...
    const calculateNewDistribution = (operation: "add" | "remove" | null, addConfig: RecipientConfigData, removeConfig: RecipientConfigData) => {
    ...
    const generatePayload = () => {
        ...
        try {
            const payload = generateInjectorSchedulePayloadV2({
                ...
                scheduleInputs: operation === 'add' ? addConfig.recipients.map(recipient => ({
        ...
        <Container maxW="container.xl">
            ...
            {selectedAddress && !isLoading && (
                <>
                    ...
                    <Box mt={6} gap={4}>
                        <Button onClick={() => setOperation("add")} mr={4}>Add Recipients</Button>
