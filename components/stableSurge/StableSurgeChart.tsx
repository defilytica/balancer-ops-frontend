...
export const StableSurgeChart: React.FC<{
  ...
  const legendItems = [
    ...
    { id: "currentBalances", color: colors.currentInvariant, text: "Current Balances", isPoint: true },
    { id: "previewBalances", color: colors.invariantWithFees, text: "Post-Swap Balances", isPoint: true },
    { id: "imbalanceThresholds", color: colors.initialInvariant, text: "Imbalance Thresholds", isPoint: true },
  ];
