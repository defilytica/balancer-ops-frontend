...
import {
  ...
  StatHelpText,
  StatArrow,
  StatGroup, InputGroup, Divider,
} from "@chakra-ui/react";
import { Download, Copy, GitPullRequest, Search, DollarSign } from "react-feather";
...
export default function FeeSetter() {
  ...
  const handleGenerateClick = () => {
    ...
    const payload = generateSwapFeeChangePayload(input, network.chainId);
      ...
      <Container maxW="container.lg">
        ...
        {loading ? (
            ...
            <>
              ...
              <Grid templateColumns="repeat(12, 1fr)" gap={4} mb={6}>
                <GridItem colSpan={{ base: 12, md: 4 }}>
                  <FormControl isDisabled={!selectedPool}>
                      ...
                      <Card>
                        <CardHeader>
                          <Flex alignItems="center">
                            <DollarSign size={24} />
                            <Heading size="md" ml={2}>Swap Fee Change Preview</Heading>
                          </Flex>
                        </CardHeader>
                        <CardBody>
                          <StatGroup>
