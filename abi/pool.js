export const poolsABI = [
        ...
        inputs: [
            {
                components: [
                    ...
                    { internalType: "bool", name: "exemptFromYieldProtocolFeeFlag", type: "bool" },
    ...
    { inputs: [], name: "isExemptFromYieldProtocolFee", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
    {
        inputs: [{ internalType: "contract IERC20", name: "token", type: "address" }],
