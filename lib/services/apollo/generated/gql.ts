 ...
 */
export function gql(
  source: "query CurrentTokenPrices($chains: [GqlChain!]) {\n  tokenGetCurrentPrices(chains: $chains) {\n    address\n    price\n    chain\n  }\n}",
 ...
 */
export function gql(
  source: "query GetTokens($chainIn: [GqlChain!], $tokensIn: [String!]) {\n  tokenGetTokens(chains: $chainIn, where: {tokensIn: $tokensIn}) {\n    chainId\n    address\n    name\n    symbol\n    decimals\n    logoURI\n    isErc4626\n    isBufferAllowed\n    underlyingTokenAddress\n  }\n}",
): (typeof documents)["query GetTokens($chainIn: [GqlChain!], $tokensIn: [String!]) {\n  tokenGetTokens(chains: $chainIn, where: {tokensIn: $tokensIn}) {\n    chainId\n    address\n    name\n    symbol\n    decimals\n    logoURI\n    isErc4626\n    isBufferAllowed\n    underlyingTokenAddress\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
  source: "query VeBalGetVotingGauges {\n  veBalGetVotingList {\n    id\n    address\n    chain\n    type\n    symbol\n    gauge {\n      address\n      childGaugeAddress\n      isKilled\n      relativeWeightCap\n      addedTimestamp\n    }\n    tokens {\n      address\n      logoURI\n      symbol\n      weight\n    }\n  }\n}",
