...
export type CurrentTokenPricesQuery = {
  __typename: "Query";
...
export type GetPoolsQuery = {
  ...
  poolGetPools: Array<{
    ...
    staking?: {
      __typename: "GqlPoolStaking";
      gauge?: { __typename: "GqlPoolStakingGauge"; id: string } | null;
    } | null;
    dynamicData: { __typename: "GqlPoolDynamicData"; swapFee: string; poolId: string };
  }>;
};

export type GetBoostedPoolsQueryVariables = Exact<{ [key: string]: never }>;
...
export type GetBoostedPoolsQuery = {
  ...
  poolGetPools: Array<{
    ...
    dynamicData: { __typename: "GqlPoolDynamicData"; totalLiquidity: string; volume24h: string };
    poolTokens: Array<{
      __typename: "GqlPoolTokenDetail";
      chain?: GqlChain | null;
      chainId?: number | null;
...
export type GetV3PoolsQuery = {
  ...
  poolGetPools: Array<{
    ...
    createTime: number;
    tags?: Array<string | null> | null;
    dynamicData: { __typename: "GqlPoolDynamicData"; swapFee: string };
    poolTokens: Array<{
      __typename: "GqlPoolTokenDetail";
      chain?: GqlChain | null;
      chainId?: number | null;
...
export const CurrentTokenPricesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CurrentTokenPrices" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<CurrentTokenPricesQuery, CurrentTokenPricesQueryVariables>;
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "EnumValue", value: "totalLiquidity" },
              },
              {
                kind: "Argument",
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "swapFeeManager" } },
                {
                  kind: "Field",
...
export const GetBoostedPoolsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetBoostedPools" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            arguments: [
              {
                ...
                value: {
                  ...
                  fields: [
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "protocolVersionIn" },
                      value: { kind: "ListValue", values: [{ kind: "IntValue", value: "3" }] },
                    },
                    {
                      kind: "ObjectField",
                    ...
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "chainNotIn" },
                      value: { kind: "EnumValue", value: "SONIC" },
                    },
                  ],
                },
              },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "name" } },
                { kind: "Field", name: { kind: "Name", value: "protocolVersion" } },
                { kind: "Field", name: { kind: "Name", value: "hasErc4626" } },
                { kind: "Field", name: { kind: "Name", value: "hasAnyAllowedBuffer" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "dynamicData" },
                  selectionSet: {
                ...
                { kind: "Field", name: { kind: "Name", value: "tags" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "underlyingToken" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "chainId" } },
                      ...
                      { kind: "Field", name: { kind: "Name", value: "isBufferAllowed" } },
                    ],
                  },
                },
              ],
...
} as unknown as DocumentNode<GetBoostedPoolsQuery, GetBoostedPoolsQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetV3Pools" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "chainIn" } },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "tags" } },
                {
                  ...
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [{ kind: "Field", name: { kind: "Name", value: "swapFee" } }],
                  },
                },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<GetV3PoolsQuery, GetV3PoolsQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "tokensIn" } },
          type: {
            kind: "ListType",
            type: {
              kind: "NonNullType",
        ...
        selections: [
          {
                  ...
                  fields: [
                    {
                      ...
                      value: { kind: "Variable", name: { kind: "Name", value: "tokensIn" } },
                    },
                  ],
                },
              },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "isErc4626" } },
                { kind: "Field", name: { kind: "Name", value: "isBufferAllowed" } },
                { kind: "Field", name: { kind: "Name", value: "underlyingTokenAddress" } },
              ],
            },
          },
        ],
...
export const VeBalGetVotingGaugesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "VeBalGetVotingGauges" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "veBalGetVotingList" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "symbol" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "address" } },
                      { kind: "Field", name: { kind: "Name", value: "childGaugeAddress" } },
                      { kind: "Field", name: { kind: "Name", value: "isKilled" } },
                      { kind: "Field", name: { kind: "Name", value: "relativeWeightCap" } },
                      { kind: "Field", name: { kind: "Name", value: "addedTimestamp" } },
                    ],
                  },
                },
                {
...
} as unknown as DocumentNode<VeBalGetVotingGaugesQuery, VeBalGetVotingGaugesQueryVariables>;
