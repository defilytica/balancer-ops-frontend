...
export type GetV3PoolsQuery = { __typename: 'Query', poolGetPools: Array<{ __typename: 'GqlPoolMinimal', id: string, symbol: string, version: number, chain: GqlChain, type: GqlPoolType, protocolVersion: number, address: string, name: string, swapFeeManager?: string | null, createTime: number, tags?: Array<string | null> | null, dynamicData: { __typename: 'GqlPoolDynamicData', swapFee: string, poolId: string }, staking?: { __typename: 'GqlPoolStaking', gauge?: { __typename: 'GqlPoolStakingGauge', id: string } | null } | null, poolTokens: Array<{ __typename: 'GqlPoolTokenDetail', chain?: GqlChain | null, chainId?: number | null, address: string, weight?: string | null, symbol: string, name: string, decimals: number, isErc4626: boolean, scalingFactor?: string | null, priceRate: string, isBufferAllowed: boolean, underlyingToken?: { __typename: 'GqlToken', chainId: number, address: string, name: string, symbol: string, decimals: number, isErc4626: boolean } | null }> }> };
