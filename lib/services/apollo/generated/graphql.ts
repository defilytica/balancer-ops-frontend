...
export type GetTokensQuery = { __typename: 'Query', tokenGetTokens: Array<{ __typename: 'GqlToken', chainId: number, address: string, name: string, symbol: string, decimals: number, logoURI?: string | null }> };
