...
export type GetV3PoolsWithHooksQuery = { __typename: 'Query', poolGetPools: Array<{ __typename: 'GqlPoolMinimal', address: string, chain: GqlChain, protocolVersion: number, name: string, symbol: string, type: GqlPoolType, version: number, createTime: number, swapFeeManager?: string | null, dynamicData: { __typename: 'GqlPoolDynamicData', poolId: string, swapFee: string }, hook?: { __typename: 'GqlHook', address: string, type: GqlHookType, params?: { __typename: 'ExitFeeHookParams' } | { __typename: 'FeeTakingHookParams' } | { __typename: 'MevTaxHookParams' } | { __typename: 'StableSurgeHookParams', maxSurgeFeePercentage?: string | null, surgeThresholdPercentage?: string | null } | null } | null }> };
...
export type GetTokensQuery = { __typename: 'Query', tokenGetTokens: Array<{ __typename: 'GqlToken', chainId: number, address: string, name: string, symbol: string, decimals: number, logoURI?: string | null, isErc4626: boolean, isBufferAllowed: boolean, underlyingTokenAddress?: string | null }> };
