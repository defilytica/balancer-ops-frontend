...
export type GetBoostedPoolsQuery = { __typename: 'Query', poolGetPools: Array<{ __typename: 'GqlPoolMinimal', chain: GqlChain, address: string, name: string, protocolVersion: number, hasErc4626: boolean, hasAnyAllowedBuffer: boolean, tags?: Array<string | null> | null, dynamicData: { __typename: 'GqlPoolDynamicData', totalLiquidity: string, volume24h: string }, poolTokens: Array<{ __typename: 'GqlPoolTokenDetail', chain?: GqlChain | null, chainId?: number | null, address: string, symbol: string, name: string, decimals: number, isErc4626: boolean, logoURI?: string | null, scalingFactor?: string | null, priceRate: string, underlyingToken?: { __typename: 'GqlToken', chainId: number, address: string, name: string, symbol: string, decimals: number, isErc4626: boolean } | null }> }> };
